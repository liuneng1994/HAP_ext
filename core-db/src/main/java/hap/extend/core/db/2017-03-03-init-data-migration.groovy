...
databaseChangeLog(logicalFilePath:"hap/extend/core/db/2017-03-03-init-data.groovy"){
...
//    }
    ...
    changeSet(author: "yazheng young", id: "20170303-init-data-xlsx", runAlways:"true"){
        customChange(class:ExcelDataLoader.class.name){
            param(name:"filePath",value:MigrationHelper.getInstance().dataPath("hap/extend/core/db/data/2017-03-03-init-data.xlsx"))
        }
    }
}
